...
/* ================= TablePanel ================= */
export default function RainAccThreeday({ data, loading, error, onSelectStation, stations, searchText, onSearchChange }) {
    ...
    <Box sx={{ display: "flex", flexDirection: "column", height: "100%" }}>
            ...
            <TableRow>
              ...
              <TableCell align="right">
                <TableSortLabel
                  ...
                  active={orderBy === "precip_3days"}
                  direction={orderBy === "precip_3days" ? order : "asc"}
                  onClick={() => {
                    const isAsc =
                      orderBy === "precip_3days" && order === "asc";
                    setOrder(isAsc ? "desc" : "asc");
                    setOrderBy("precip_3days");
                  }}
                  sx={{
                    ...
                    <TableCell align="right">
                      <Box
                        ...
                        sx={{
                          ...
                          py: 0.4,
                          borderRadius: 1,
                          backgroundColor: row.rain3dMeta.color,
                          color: row.precip_3days > 35 ? "#000" : "#333",
                          fontWeight: 500,
                          minWidth: 64,
                          textAlign: "center",
                        }}
                      >
                        {row.precip_3days ?? "ไม่ได้รับรายงาน"}
                      </Box>
                    </TableCell>
                  </TableRow>
                ))}
      ...
      <Box sx={{ px: 2, pb: 1 }}>
        <Typography variant="caption" color="text.secondary" sx={{ fontSize: { xs: 12, md: 14 } }}>
          หมายเหตุ: ฝนสะสม 3 วัน หมายถึง ข้อมูลปริมาณปริมาณฝนสะสม 3 วัน
        </Typography>
      </Box>
    </Box>
  );
