...
/* ================= TablePanel ================= */
export default function RainAccYesterday({ data, loading, error, onSelectStation }) {
            ...
            <TableRow>
              ...
              <TableCell align="right">
                <TableSortLabel
                  ...
                  active={orderBy === "precip_yesterday"}
                  direction={orderBy === "precip_yesterday" ? order : "asc"}
                  onClick={() => {
                    const isAsc =
                      orderBy === "precip_yesterday" && order === "asc";
                    setOrder(isAsc ? "desc" : "asc");
                    setOrderBy("precip_yesterday");
                  }}
                  sx={{
                    ...
                    <TableCell align="right">
                      <Box
                        ...
                        sx={{
                          ...
                          py: 0.4,
                          borderRadius: 1,
                          backgroundColor: row.rainlastMeta.color,
                          color: row.precip_yesterday > 35 ? "#000" : "#333",
                          fontWeight: 500,
                          minWidth: 64,
                          textAlign: "center",
                        }}
                      >
                        {row.precip_yesterday ?? "ไม่ได้รับรายงาน"}
                      </Box>
                    </TableCell>
                  </TableRow>
                ))}
